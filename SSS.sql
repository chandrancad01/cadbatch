use ai_tamil;
create table system_detail(SI_NO INT NOT NULL PRIMARY KEY, NAME VARCHAR(40) NOT NULL,SYSTEM_NUMBER INT NOT NULL,
...
create table system_info(SI_NO INT NOT NULL PRIMARY KEY,USER_ID INT , NAME VARCHAR(40) NOT NULL,SYSTEM_NUMBER INT NOT NULL,
ERROR VARCHAR(50),OS_NAME VARCHAR(50),RAM VARCHAR(70),PROCESSOR VARCHAR(50),MOUSE_CONDITION VARCHAR(40),KEY_BOARD_CONDITION VARCHAR(40),foreign key(USER_ID)references system_info(USER_ID);
